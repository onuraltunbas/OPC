...
# =====================================================================
# 2. BÖLÜM: KURULUM PENCERESİ (SSL VE MS STORE FİX UYGULANDI)
# =====================================================================
class KurulumPenceresi(QtWidgets.QDialog):
    ...
    def python_indir_ve_kur(self):
        ...
        def download():
            ...
            self.log_yaz("📥 Python 3.13 indiriliyor... (SSL Koruması Aşıldı)")
            try:
                # SSL Hatasını Yoksay (Sanal Makine Kurulumları İçin)
    ...
    def kutuphaneleri_kur(self):
        # MS Store'a gitmesini önlemek için doğrudan python çağrılır
...
# =====================================================================
# 3. BÖLÜM: GATEWAY MOTORU (MATRIKON ÇÖKME FİXİ - TEKİL OKUMA)
# =====================================================================
class GatewayWorker(QThread):
    ...
    def run(self):
        try:
            ...
            async def main_loop():
                ...
                async with srv:
                    ...
                    while self.is_running:
                        # BUG FIX: Matrikon'un liste atıldığında çökmesini önlemek için TEKİL (Single) okuma döngüsü
                            ...
                            try:
                                ...
                                if sonuc and len(sonuc) >= 3:
                                    ...
                                    if val is not None and qual == 'Good':
                                        ...
                                        # Kalite kötü gelirse konsolda bilgi ver (0 yazma sebebi anlaşılır)
                                        pass 
                            except Exception as alt_hata:
                                print(f"⚠️ Sensör Hatası ({et_adi}): Matrikon'dan okunamadı.")
                                
                        print(f"⏳ Akış Aktif: Veriler işleniyor ve UA'ya aktarılıyor...")
            ...
            print("❌ Kütüphaneler eksik! Lütfen sol üstteki 'Kurulum' menüsünden kurulumları tamamlayın.")
        except Exception as e: 
...
class GatewayApp(QtWidgets.QMainWindow, Ui_btn_sunucu_tara):
    ...
    def etiket_tara(self):
        try:
            ...
            opc.close()
            print(f"✅ Etiketler listeye eklendi. Listeden okumak istediklerinizi 'Mavi' olacak şekilde seçin.\n")
        except: 
    ...
    def baslat(self):
        ...
        if not tags:
            return QtWidgets.QMessageBox.warning(self, "Hata", "Listeden okumak istediğiniz etiketleri işaretleyin (CTRL basılı tutarak çoklu seçebilirsiniz)!")
...
# EXE'nin kendi kendini klonlayıp çökmesini önleyen en kritik komut (Alt)
